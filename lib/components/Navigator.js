...
function Navigator(props) {
    const { classes, navigatorConfig, toggleDraw, history } = props, other = __rest(props, ["classes", "navigatorConfig", "toggleDraw", "history"]);
    return (React.createElement(Drawer_1.default, Object.assign({ variant: "permanent" }, other),
        React.createElement(List_1.default, { disablePadding: true },
            React.createElement(ListItem_1.default, { className: clsx_1.default(classes.firebase, classes.item, classes.itemCategory) }, navigatorConfig.title),
            React.createElement(ListItem_1.default, { component: react_router_dom_1.Link, to: '/', onClick: toggleDraw, className: clsx_1.default(classes.item, classes.itemCategory) },
                React.createElement(ListItemIcon_1.default, { className: classes.itemIcon }, navigatorConfig.mainPage.icon),
                React.createElement(ListItemText_1.default, { classes: {
                        primary: classes.itemPrimary,
                    } }, navigatorConfig.mainPage.id)),
            navigatorConfig.groups.map(({ id, children }) => (React.createElement(React.Fragment, { key: id },
                React.createElement(ListItem_1.default, { className: classes.categoryHeader },
                    React.createElement(ListItemText_1.default, { classes: {
                            primary: classes.categoryHeaderPrimary,
                        } }, id)),
                children.map(({ id: childId, icon, uri }) => (React.createElement(ListItem_1.default, { button: true, key: childId, component: react_router_dom_1.Link, to: uri, onClick: toggleDraw, className: clsx_1.default(classes.item, history.location.pathname.indexOf(uri) == 0 && classes.itemActiveItem) },
