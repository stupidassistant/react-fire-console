...
function Navigator(props) {
    ...
    return (React.createElement(Drawer_1.default, Object.assign({ variant: "permanent" }, other),
        React.createElement(List_1.default, { disablePadding: true },
            ...
            React.createElement(ListItem_1.default, { component: react_router_dom_1.Link, to: '/', className: clsx_1.default(classes.item, classes.itemCategory) },
            ...
            navigatorConfig.groups.map(({ id, children }) => (React.createElement(React.Fragment, { key: id },
                ...
                children.map(({ id: childId, icon, uri }) => (React.createElement(ListItem_1.default, { button: true, key: childId, component: react_router_dom_1.Link, to: uri, className: clsx_1.default(classes.item, false && classes.itemActiveItem) },
