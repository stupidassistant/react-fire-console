...
function Navigator(props) {
    ...
    return (React.createElement(Drawer_1.default, __assign({ variant: "permanent" }, other),
        React.createElement(List_1.default, { disablePadding: true },
            ...
            navigatorConfig.groups.map(function (_a) {
                ...
                return (React.createElement(React.Fragment, { key: id },
                    ...
                    children.map(function (_a) {
                        var childId = _a.id, icon = _a.icon, uri = _a.uri;
                        return (React.createElement(ListItem_1.default, { button: true, key: childId, component: react_router_dom_1.Link, to: uri, onClick: toggleDraw, className: clsx_1.default(classes.item, history.location.pathname.indexOf(uri) == 0 && classes.itemActiveItem) },
