...
var DefaultNavigatorConfig_1 = require("./DefaultNavigatorConfig");
...
var Paperbase = (function (_super) {
    ...
    Paperbase.prototype.render = function () {
        var _a = this.props, classes = _a.classes, propsNavigatorConfig = _a.navigatorConfig;
        var navigatorConfig = propsNavigatorConfig || DefaultNavigatorConfig_1.default;
